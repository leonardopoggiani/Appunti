...
if __name__ == '__main__':
    f = open("C:\\Users\Leonardo Poggiani\\Documents\\GitHub\\Appunti\\Cybersecurity\\Laboratorio\\2021_03_10 Python3 Lab\\Nuclear_threat\\Easy\\to_be_decrypted\\captured_ct_easy.txt", "rb")
    ct = list(f.read())
    ...
    pt = []
    # trovo la sequenza delle chiavi generate
